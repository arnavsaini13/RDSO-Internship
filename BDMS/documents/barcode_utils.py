...
def _decode_barcode_with_ocr(image):
    """Try to decode standard barcode, fallback to OCR to read text below the barcode"""
    ...
    try:
        ...
        if is_pdf:
            ...
            for page in pdf_doc:
                ...
                data = _decode_barcode_with_ocr(cv_img)
                if data:
                    pdf_doc.close()
                    return data
        ...
        return _decode_barcode_with_ocr(image)
